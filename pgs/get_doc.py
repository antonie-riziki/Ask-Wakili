...
st.image('https://www.mswlaw.ae/assets/images/case/legal-consultancy.jpg', width=1200)
...
uploaded_files = st.file_uploader('Upload Document [Pdf/Csv]', accept_multiple_files=True)
